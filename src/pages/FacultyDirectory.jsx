...
const FacultyDirectory = () => {
    ...
    const filtered = facultyList.filter(f => {
        ...
        const matchCode = courseFilter === 'All' || f.courses?.some(c => c.code === courseFilter);
    ...
    // Award points for calling faculty — use navigate instead of window.location.href
    ...
    const inputStyle = { width: '100%', padding: '12px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(0,0,0,0.3)', color: 'white', outline: 'none' };
            ...
            <GlassCard className="mb-6">
                ...
                <div style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                    <div style={{ flex: 1, minWidth: '250px' }}>
                        <GlassInput icon={Search} placeholder="Search name or course..." value={search} onChange={e => setSearch(e.target.value)} style={{ margin: 0 }} />
                    </div>
                    <div style={{ display: 'flex', gap: '0.5rem', overflowX: 'auto', paddingBottom: '5px', alignItems: 'center' }}>
                    ...
                    <GlassCard onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: '500px', margin: '20px', position: 'relative' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            <div style={{ padding: '10px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px' }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginLeft: '30px' }}>
                                    {selectedFaculty.courses?.length > 0 ? selectedFaculty.courses.map((c, i) => (
                            ...
                            <div style={{ padding: '10px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    ...
                                    <div><p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', margin: 0 }}>Phone</p><p style={{ margin: 0 }}>{selectedFaculty.phone || "N/A"}</p></div>
                                </div>
                            </div>
                            <div style={{ padding: '10px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px' }}>
                        ...
                        <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', alignItems: 'center' }}>
                            <GlassButton
                                ...
                                onClick={() => handleCallFaculty(selectedFaculty.phone)}
                            >
                                <Phone size={16} style={{ marginRight: '6px' }} /> Call Now
                            </GlassButton>
                            {currentUser && (
                                <span style={{ fontSize: '0.75rem', color: '#34D399' }}>+{POINTS.CALL_FACULTY} pts</span>
                            )}
                        </div>
                    </GlassCard>
                </div>
