...
import { Search, Mail, Phone, MapPin, User, X } from 'lucide-react';
...
const FacultyDirectory = () => {
  const { faculty = [] } = useData();   // ✅ Safe default
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem' }}>
              <GlassButton variant="gradient" style={{ flex: 1, justifyContent: 'center' }}>
                Call Now
              </GlassButton>
              <GlassButton style={{ flex: 1, justifyContent: 'center' }}>
                Send Email
              </GlassButton>
            </div>
          </GlassCard>
