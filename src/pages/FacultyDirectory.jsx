...
const FacultyDirectory = () => {
    ...
    const activeLabel = courseFilter !== 'All' ? courseFilter : null;
            ...
            <GlassCard className="mb-6">
                ...
                <div style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                    <div style={{ flex: 1, minWidth: '250px' }}>
                        <GlassInput icon={Search} placeholder="Search Name (e.g. Gopi)..." value={search} onChange={(e) => setSearch(e.target.value)} style={{ margin: 0 }} />
                    </div>
                ...
                {activeLabel && (
                    <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                        ...
                        <span style={{ fontSize: '0.75rem', background: 'rgba(59,130,246,0.2)', color: 'white', padding: '2px 10px', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                            {activeLabel}
                            <X size={12} style={{ cursor: 'pointer' }} onClick={() => setCourseFilter('All')} />
                        </span>
                    </div>
                )}
            </GlassCard>
