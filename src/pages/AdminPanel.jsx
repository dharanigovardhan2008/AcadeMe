...
// --- UPDATES MANAGEMENT (UPDATED WITH DELETE AND LINK) ---
                ...
                {updates.map(u => (
                    <div key={u.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
                        <div>
                            ...
                            {u.link && (
                                <a href={u.link} target="_blank" rel="noreferrer" style={{ display:'flex', alignItems:'center', gap:'5px', marginTop:'5px', color:'#38BDF8', fontSize:'0.85rem' }}>
