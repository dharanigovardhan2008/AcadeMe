        ...
        <DashboardLayout>
            <style>{`
                ...
                @media (max-width: 480px) {
                    ...
                    .mc-course-card { padding: 0.7rem 0.85rem; gap: 0.5rem; }
                    .mc-grade-dot { width: 30px; height: 30px; font-size: 0.72rem; }
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mc-course-right">
                                    {currentGrade && <CheckCircle size={14} color="#34D399" />}
