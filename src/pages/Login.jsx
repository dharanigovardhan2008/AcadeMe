...
import { Mail, Lock, LogIn, ArrowRight, ShieldCheck, Zap, Globe, Cpu } from 'lucide-react'; // Added decorative icons
...
const Login = () => {
    ...
    return (
        <div style={{ 
            ...
            <div className="bg-tech-grid" style={{
            ...
            {/* 3. FLOATING DECORATIVE ICONS (3D Feel) */}
            ...
            {/* LOGIN CARD */}
            <div className="animate-fade-in-up" style={{ width: '100%', maxWidth: '440px', padding: '20px', zIndex: 10 }}>
                <GlassCard className="glass-card" style={{ 
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                        ...
                        <h2 className="gradient-text" style={{ fontSize: '2.2rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>Welcome Back</h2>
                        <p style={{ color: 'var(--text-secondary)' }}>Enter your details to access your dashboard</p>
                    </div>

                    {error && <div style={{ background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.3)', color: '#FCA5A5', padding: '12px', borderRadius: '12px', marginBottom: '1.5rem', fontSize: '0.9rem', textAlign: 'center' }}>{error}</div>}
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', color: 'var(--text-secondary)', padding: '0 5px' }}>
