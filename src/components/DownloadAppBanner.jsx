...
const DownloadAppBanner = () => {
  ...
  const downloadAPK = () => {
    ...
    // Hidden anchor — stays on page, no CORS issue, browser handles natively
    ...
    // Simulate progress bar since native downloads can't be tracked
    let current = 0;
    ...
    // Mark complete after 4s — browser download bar handles the rest
    setTimeout(() => {
      clearInterval(interval);
      setProgress(100);
      setPhase("done");
    ...
    <>
      <style>{`
        ...
        .ps-backdrop {
          ...
          z-index:99998; animation:fadeIn 0.3s ease forwards;
        }
        .ps-wrap {
        ...
        .ps-sheet {
          background:#1f1f1f; border-radius:28px 28px 0 0;
          overflow:hidden; box-shadow:0 -4px 40px rgba(0,0,0,0.7);
        }
        .ps-handle {
        ...
        .ps-icon img { width:100%; height:100%; object-fit:cover; border-radius:16px; }
        ...
        .ps-stats { display:flex; border-bottom:1px solid rgba(255,255,255,0.07); }
        ...
        .ps-actions {
          display:flex; gap:12px; padding:16px 20px 32px; align-items:center;
        }
        .ps-btn-install {
          flex:1; height:48px; background:#01875f; border:none;
          border-radius:24px; color:#fff; font-size:15px; font-weight:700;
      ...
      <div className="ps-backdrop" onClick={phase === "downloading" ? undefined : handleLater} />
      ...
      <div className="ps-wrap">
        <div className="ps-sheet">
          ...
          <div className="ps-header">
            ...
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <div className="ps-chips">
                <div className="ps-chip"><span style={{color:"#fbbc04"}}>★</span> 4.8</div>
          ...
          <div className="ps-actions">
            ...
            >
              {phase === "downloading" && <><div className="ps-spinner"/> Downloading {progress}%</>}
              {phase === "done"        && <span className="ps-check">
