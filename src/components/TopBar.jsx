...
import { Bell, Menu, User, X, MessageCircle, Send, Globe, Instagram } from 'lucide-react';
        ...
        <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <a
                    ...
                    title="Instagram"
                    style={{ ...iconButtonStyle, color: 'var(--text-secondary)', textDecoration: 'none' }}
                    ...
                    {showNotifications && (
                        <div style={{
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                ...
                                <button onClick={() => setShowNotifications(false)} style={{ background: 'none', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer' }}>
                                    <X size={16} />
                                </button>
                            </div>
                                        ...
                                        <div key={note.id} style={{ background: 'rgba(255,255,255,0.05)', padding: '12px', borderRadius: '8px' }}>
                                            <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                                                ...
                                                <div style={{ flex: 1, minWidth: 0 }}>
                                                    ...
                                                    <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.9)', wordBreak: 'break-word' }}>{note.message}</p>
                                            ...
                                            <div style={{ display: 'flex', gap: '5px', marginTop: '0.5rem' }}>
                                                ...
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        width: '32px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
