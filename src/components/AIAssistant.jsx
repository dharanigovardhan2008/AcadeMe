...
const AIAssistant = () => {
    ...
    const [messages, setMessages] = useState([
        { role: 'model', text: "Hi! I'm your AcadeMe AI. 🤖\n\nI can help you summarize notes, explain topics, or create study schedules. Ask me anything!" }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            console.error(error);
            setMessages(prev => [...prev, { role: 'model', text: "⚠️ I couldn't connect. Please check your internet or API Key." }]);
        }
        setLoading(false);
    };
